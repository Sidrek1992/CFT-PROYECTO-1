...
const createEmp = (id: string, firstName: string, lastName: string, rut?: string): EmployeeExtended => ({
  id,
  firstName,
  lastName,
  rut: rut || '',
...
export const INITIAL_REQUESTS: LeaveRequest[] = [
  ...
  createReq('119', '16', '2026-01-16', '2026-01-16', 1.0, LeaveType.ADMINISTRATIVE, WorkShift.JC),
  createReq('120', '17', '2026-01-23', '2026-02-06', 11.0, LeaveType.LEGAL_HOLIDAY, WorkShift.JC),
];
